...
_SOKOL_PRIVATE void _sg_d3d11_clear_state(void) {
    ...
    ID3D11DeviceContext_CSSetUnorderedAccessViews(_sg.d3d11.ctx, 0, SG_MAX_SHADERSTAGE_UAVS, _sg.d3d11.zero_uavs, 0);
    ID3D11DeviceContext_CSSetShaderResources(_sg.d3d11.ctx, 0, SG_MAX_SHADERSTAGE_IMAGES, _sg.d3d11.zero_srvs);
    ID3D11DeviceContext_CSSetSamplers(_sg.d3d11.ctx, 0, SG_MAX_SHADERSTAGE_IMAGES, _sg.d3d11.zero_smps);
}
...
_SOKOL_PRIVATE sg_resource_state _sg_d3d11_create_buffer(_sg_buffer_t* buf, const sg_buffer_desc* desc) {
    ...
    if (injected) {
        ...
        if (buf->cmn.type == SG_BUFFERTYPE_RAW) {
            ...
            hr = ID3D11Device_CreateShaderResourceView(_sg.d3d11.dev, (ID3D11Resource*)buf->d3d11.buf, &srv_desc, &buf->d3d11.srv);
            ...
            if (desc->shader_write) {
                ...
                hr = ID3D11Device_CreateUnorderedAccessView(_sg.d3d11.dev, (ID3D11Resource*)buf->d3d11.buf, &uav_desc, &buf->d3d11.uav);
...
_SOKOL_PRIVATE void _sg_d3d11_destroy_buffer(_sg_buffer_t* buf) {
    ...
    if (buf->d3d11.srv) {
        ID3D11Buffer_Release(buf->d3d11.srv);
    }
    if (buf->d3d11.uav) {
        ID3D11Buffer_Release(buf->d3d11.uav);
    }
}
...
_SOKOL_PRIVATE void _sg_d3d11_destroy_image(_sg_image_t* img) {
    ...
    if (img->d3d11.uav) {
        ID3D11UnorderedAccessView_Release(img->d3d11.uav);
    }
}
...
_SOKOL_PRIVATE sg_resource_state _sg_d3d11_create_shader(_sg_shader_t* shd, const sg_shader_desc* desc) {
    ...
    if (desc->cs.byte_code || desc->cs.source) {
        ...
        if (cs_blob) {
            ID3D10Blob_Release(cs_blob); cs_blob = 0;            
        }
...
_SOKOL_PRIVATE void _sg_d3d11_destroy_shader(_sg_shader_t* shd) {
    ...
    if (shd->d3d11.cs) {
        ID3D11ComputeShader_Release(shd->d3d11.cs);
    }
...
_SOKOL_PRIVATE void _sg_d3d11_apply_pipeline(_sg_pipeline_t* pip) {
    ...
    if (pip->shader->cmn.compute_shader) {
        ID3D11DeviceContext_CSSetShader(_sg.d3d11.ctx, pip->shader->d3d11.cs, NULL, 0);
        ID3D11DeviceContext_CSSetConstantBuffers(_sg.d3d11.ctx, 0, SG_MAX_SHADERSTAGE_UBS, pip->shader->d3d11.stage[SG_SHADERSTAGE_CS].cbufs);
	} 
    else {
    ...
    _sg_buffer_t** cs_buf_uavs, int num_cs_buf_uavs)
{
    ...
    if (!pip->shader->cmn.compute_shader) {
	    ...
	    ID3D11DeviceContext_CSSetUnorderedAccessViews(_sg.d3d11.ctx, 0, SG_MAX_SHADERSTAGE_UAVS, d3d11_cs_uavs, 0);
        ID3D11DeviceContext_CSSetShaderResources(_sg.d3d11.ctx, 0, SG_MAX_SHADERSTAGE_IMAGES, d3d11_cs_srvs);
