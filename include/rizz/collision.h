...
static inline rizz_coll_ray coll_ray_set(sx_vec3 origin, sx_vec3 dir, float len)
{
#ifndef __cplusplus
...
static inline rizz_coll_ray coll_ray_set_denorm(sx_vec3 origin, sx_vec3 dir_len)
{
    float len;
    sx_vec3 dir = sx_vec3_norm_len(dir_len, &len);
    return coll_ray_set(origin, dir, len);
}
